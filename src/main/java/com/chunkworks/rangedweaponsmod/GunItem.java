...
public final class GunItem extends Item {
    ...
    /** effects: returns whether {@code stack} is a gun fed from a detachable magazine by design */
    public static boolean isMagazineFed(ItemStack stack) {
        return stack.getItem() instanceof GunItem gun && gun.feed() == Feed.MAGAZINE;
    }

    /**
     * effects: returns whether {@code stack} is a gun that takes a magazine
     * under {@code mode}: fed from one by design, with the server requiring
     * them; in loose mode no gun does
     */
    public static boolean usesMagazines(ItemStack stack, FeedMode mode) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        boolean magazines = usesMagazines(stack);
        if (magazines) {
