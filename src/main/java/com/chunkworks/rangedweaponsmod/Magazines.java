...
public final class Magazines {
    ...
    /**
     * Loose mode's mirror of {@link #adopt}: a gun still holding a magazine
     * hands it back on first sight, load and all, and loads loose rounds
     * from then on.
     *
     * <p>effects: if {@code gun} has a magazine inserted, takes it out,
     * leaving the store empty, and puts it in the player's inventory -- at
     * their feet if nothing fits; otherwise nothing. Returns whether it did.
     */
    public static boolean handBack(Player player, ItemStack gun, RangedWeapon weapon) {
