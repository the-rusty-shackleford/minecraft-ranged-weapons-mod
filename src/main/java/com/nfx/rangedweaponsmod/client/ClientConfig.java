...
public final class ClientConfig {
    ...
    public static final ModConfigSpec.DoubleValue MODEL_BACK;
    ...
    static {
        ...
        MODEL_BACK = builder
                .comment("Blocks the gun in your hand is pushed back toward your shoulder per degree of camera kick.")
                .defineInRange("modelBackPerDegree", 0.07D, -0.5D, 0.5D);

        MODEL_RISE = builder
                .comment("Blocks the gun in your hand rises per degree of camera kick. A gun pushed back grows and, low on screen,",
                        "slides down in perspective; about 0.7 of the push in rise holds it level, more lifts it.")
                .defineInRange("modelRisePerDegree", 0.06D, -0.3D, 0.3D);

        MODEL_PITCH = builder
                .comment("Degrees the gun in your hand tilts about its grip per degree of camera kick. Positive is muzzle up.")
                .defineInRange("modelPitchPerDegree", 3.0D, -30.0D, 30.0D);
