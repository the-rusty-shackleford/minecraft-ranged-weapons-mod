...
Every shot and action sound shipped by this mod is cut from a field recording of a real firearm,
...
(Freesound's high-quality Vorbis previews); `build.py` cuts, re-times, mixes and normalizes them
